...
for epoch in range(args.num_epoch):
    ...
    if accuracy > best_acc:
        ...
        torch.save(best_model.state_dict(), 'best_model_cifar10h.pth_cl_HC.tar')
...
write_csv("CL_HCLS+HC1.csv", ["init_prob:" + str(args.initial_prob), "epoch_iid:" + str(args.epoch_iid),
