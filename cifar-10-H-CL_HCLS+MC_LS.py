...
#get_ipython().run_line_magic('cd', 'cifar-10h')
...
for epoch in range(args.num_epoch):
    ...
    if accuracy > best_acc:
        ...
        torch.save(best_model.state_dict(), 'best_model_cifar10h.pth_cl_HCLS+MC_LS.tar')
...
write_csv("CL_HCLS+MC2.csv", ["init_prob:" + str(args.initial_prob), "epoch_iid:" + str(args.epoch_iid),
